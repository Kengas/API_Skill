...
app.get('/list_std' , async ( req , res ) =>{
    ...
    try{
        ...
        .join('groups' , 'users_advisor.user_id' , '=' , 'groups.id')
        ...
        .select('users_student.user_id as student_user_id' , 'users_student.student_id' , 'users_student.firstname as user_first' , 'users_student.lastname as user_last' , 'users_student.group_id' , 'users_student.major_id' , 'advisors_groups.advisor_id' , 'users_advisor.firstname as advisor_first' , 'users_advisor.lastname as advisor_last' , 'users_advisor.user_id' , 'groups.group_name')
...
app.post('/save' , async ( req , res ) =>{
    try{       
        ...
        for(let index = 0 ; index < req.body.length ; index++){
         let  row = await db('activity_project').insert(
                {
                    ...
                    // user_id: req.body[index][4].student_user_id,
        ...
        console.log(`status-index => ` , req.body)
